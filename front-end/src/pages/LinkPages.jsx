...
function Link () {
    ...
    return (
       <>
        ...
        <Navbar/>
        <div className="flex justify-center items-center bg-white-100 mt-20">
        <div className="grid grid-cols-1 gap-4 bg-white mt-1 max-w-full mx-auto p-4 mb-3 rounded-lg">
                <div className="p-5 ">
                    <TableLink />
                </div>
