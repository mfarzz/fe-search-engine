...
const SearchWthLogo = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto pt-4 " ref={searchRef}>
      ...
      <div 
        className={`bg-blue-100 rounded-3xl mt-10 text-white ${
          ...
          {isOpen && (
            <div className="px-2 pb-2">
              ...
              {(!searchTerm ? recentSearches : suggestions).map((item, index) => (
                <div
                  key={index}
                  className="flex items-center px-4 py-2 hover:bg-blue-premier rounded-lg cursor-pointer"
